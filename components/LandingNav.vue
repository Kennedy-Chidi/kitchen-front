<template>
  <div
    ...
    data-easing2="ease"
    role="banner"
    class="landing-nav w-nav"
  >
    <div class="custom-container-landing flex">
      <nuxt-link to="/home" class="landing-brand w-nav-brand"
        ><img
      ...
      <ul role="list" class="nav-list landing">
        <li class="nav-link-flex">
          <nuxt-link to="/home" class="nav-link active">Home</nuxt-link>
        </li>
      </ul>
