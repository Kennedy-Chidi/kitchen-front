...
export default {
  ...
  methods: {
    ...
    toggleEmail(int) {
      this.$store.commit("emailStore/TOGGLE_EMAIL", int);
    },

    checkAllEmails() {
      this.isAllChecked = !this.isAllChecked;
      this.$store.commit("emailStore/CHECK_ALL_EMAILS", this.isAllChecked);
    },
  ...
  computed: {
    ...
    selectedEmails() {
      return this.$store.state.emailStore.selectedEmails;
    },
  },
